...
var PageEditor = function (_Component) {
    ...
    function PageEditor(props) {
        ...
        (0, _Game.observe)(_this.observe.bind(_this));
        return _this;
    }
    ...
    (0, _createClass3.default)(PageEditor, [{
        ...
        value: function render() {
            return _react2.default.createElement(_Board2.default, { knightPosition: this.state.position });
        }
    }]);
    return PageEditor;
}(_react.Component);
...
//# sourceMappingURL=0.43ec056b6a876ac6eeeb.hot-update.js.map